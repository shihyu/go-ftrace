...
type GoftraceSpecs struct {
	...
	GoftraceMapSpecs
	GoftraceVariableSpecs
}

// GoftraceProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// GoftraceVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// GoftraceVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadGoftraceObjects or ebpf.CollectionSpec.LoadAndAssign.
type GoftraceVariables struct {
